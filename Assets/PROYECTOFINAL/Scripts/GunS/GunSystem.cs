...
public class GunSystem : NetworkManager//////////////////////////////////////////////////////////
{
    [Header("GunStats")]
    public int damage, magSize, bulletsPerTap;
    public float timeBetweenEachShot, spread, range, reloadTime, timeBetweenEachBullet;
    ...
    private void Shoot()
    {
        ...
        Invoke("ResetShot", timeBetweenEachShot);

        if (bulletsShot > 0 && bulletsLeft > 0)
        {
            Invoke("Shoot", timeBetweenEachBullet);
        }
    }
